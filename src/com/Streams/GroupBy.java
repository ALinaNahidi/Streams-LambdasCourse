...
public class GroupBy {
    public static void main(String[] args) {
        List<Student> studentList = List.of(new Student(111, "Jiya Brein", 17, "Female", "Computer Science", 2018, 70.8)
        ...
        var doubleGrouping = studentList.stream()
                .collect(Collectors.groupingBy(Student::getAge,Collectors.groupingBy(Student::getGender)));
